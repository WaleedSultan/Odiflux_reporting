    ...
    def _select(self):
        ...
        return """
            ...
            SELECT
                ...
                aq.quantity * pp.standard_price AS total_value,
                aq.stock_age_days,
                CASE
                ...
                -- Band values
                CASE WHEN aq.stock_age_days <= 30 THEN aq.quantity * pp.standard_price ELSE 0 END AS band_0_30_value,
                CASE WHEN aq.stock_age_days > 30 AND aq.stock_age_days <= 60 THEN aq.quantity * pp.standard_price ELSE 0 END AS band_31_60_value,
                CASE WHEN aq.stock_age_days > 60 AND aq.stock_age_days <= 90 THEN aq.quantity * pp.standard_price ELSE 0 END AS band_61_90_value,
                CASE WHEN aq.stock_age_days > 90 THEN aq.quantity * pp.standard_price ELSE 0 END AS band_90_plus_value
            FROM aged_quants aq
